...
- (void)displayUIs {
    ...
    VMarqueeBar* marqueeBar = [VMarqueeBar marqueeBarWithFrame:CGRectMake(10, 140, self.view.bounds.size.width-20, 44) title:text];
    marqueeBar.tintColor = [UIColor whiteColor];
    marqueeBar.backgroundColor = [UIColor blackColor];
    [self.view addSubview:marqueeBar];
    
    V2MarqueeBar* marqueeBar2 = [V2MarqueeBar marqueeBarWithFrame:CGRectMake(10, 200, 320, 40) title:text];
    marqueeBar2.tintColor = [UIColor orangeColor];
    [self.view addSubview:marqueeBar2];
    
    V3MarqueeBar *marqueeBar3 = [V3MarqueeBar marqueeBarWithFrame:CGRectMake(10.0, 260.0, 200.0, 30.0) title:text];
